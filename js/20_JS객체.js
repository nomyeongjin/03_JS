/* 
    * JS 객체
    ...
    - (중요) key는 무조선 문자열 (String)
      -> "key", 'key', key ("",'' 생략해도 문자열(string)으로 인식)
...
btn1.addEventListener("click",()=>{
    ...
    // 1) 객체명.key
    console.log(product.productName, product.price, product.brand);
...
function Student(name, grade, ban, number, score){
    ...
    this.introduce = function(){
        console.log(`${this.grade}학년 ${this.ban}반 ${this.number}번 ${this.name} ${this.score}입니다.`);
    }
