...
console.log("menu : ",menu);
// 변수명이 중복되어 덮어쓰기 되면
// 이전에 선언해놓은 변수를 쓸 수 없게 되는 문제가 생김
// (나중에 쓰려고 했는데 나도 모르게 지워져있네;)
...
// 변수명 중복 오류 발생!
// let number3 = 500; //블록 범위 변수 'number3'을(를) 다시 선언할 수 없습니다.
...
console.log("ubdef :", undef, typeof undef);
